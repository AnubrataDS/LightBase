...
import lightbase.service.DBService;
...
public class Main {
	...
	public static void main(String args[]) {
		...
		Thread dbservicethread = new Thread(new Runnable(){
			public void run()
			{
			DBService dbservice = new DBService(queryPortNo,notificationPortNo,fileName);
			}
		});
